...
int main()
{
    ...
    char nombres[10][50] = {"Matías Rambado", "Nair Gracia", "Carlos Ramírez", "Valeria Pérez", "Marcelo Denis", "Nicolás Canil", "Cristian Rodríguez", "Celeste Plano", "Leonela Oricain", "Anita Zapata"};
    float saldo[10] = {450000.0, 598000.0, 700000.0, 999000.0, 190000.0, 267000.0, 350987.0, 123000.0, 98000.0, 568098.0};
    char estadoCuenta[10][10] = {
        "Activo",
        "Activo",
        "Activo",
        "Activo",
    ...
    do
    {
        ...
        operacionesRealizadas++;
        // Verificar límite de operaciones if (operacionesRealizadas >= 10)
        {
...

    {
        ...
        // Verificar límite de intentos fallidos if (intentosFallidos[clienteActual] >= intentosMaximos)
        {
